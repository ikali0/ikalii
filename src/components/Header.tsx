      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 pill-nav px-4 sm:px-6">
          ...
          <nav className="hidden md:flex items-center gap-2">
            ...
            <a className="text-sm font-medium hover:bg-muted/60 rounded-full px-4 py-2 transition-all" href="/Work">
              ​Work
            </a>
            <a className="text-sm font-medium hover:bg-muted/60 rounded-full px-4 py-2 transition-all" href="/Projects">
              ​Projects
            </a>
